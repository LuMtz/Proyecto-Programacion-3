...
public class JFrameRegUsuario extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JFrameRegUsuario frame = new JFrameRegUsuario();
	 ...
	 * Create the frame.
	 */
	public JFrameRegUsuario() {
		getContentPane().setBackground(new Color(192, 192, 192));
		getContentPane().setLayout(null);
		
		JLabel lblNewLabel = new JLabel("REGISTRO DE USUAIOS");
		...
		btnNewButton.setBounds(154, 480, 174, 22);
